...
const AboutArea = () => {
  return (
    <>
      <section
        className="about--area pt-20 pb-20 wow fadeInUp"
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-xl-7 col-lg-6 col-md-12 col-12">
              <div className="tp-ab-circle-img p-relative mb-20">
            ...
            <div className="col-xl-5 col-lg-6 col-md-12 col-12">
              <div className="tp-abcircle-content ml-65 mb-20">
                ...
                <div className="about-circle-list mb-20">
                  <ul>
