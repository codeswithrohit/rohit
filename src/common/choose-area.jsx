...
const ChooseArea = ({style_about, style_2}) => {
  return (
    <>
      <section
        className={`choose-area bg-bottom ${style_about ? "pb-10" : "grey-bg"} ${style_2 ? "pt-10 pb-10" : ""} wow fadeInUp`}
          ...
          <div className="row align-items-center">
            <div className="col-xl-5 col-lg-6 col-md-12">
              <div className="tp-choose-content mb-10">
                ...
                <div className="tp-choose-list tp-choose-bg mb-10">
                  <ul>
            ...
            <div className="col-xl-7 col-lg-6 col-md-12">
              <div className="tp-choose-img tp-choose-img-2 p-relative mb-10 mr-50 text-end">
