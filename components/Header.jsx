...
const dropdownNavs = [
    {
        label: "Components", navs: [
            {
                title: "Tailwind Css",
                desc: "More than 100+ Components",
...
export default () => {
    ...
    const navigation = [
        { title: "Components", path: "javascript:void(0)", isDrapdown: true, navs: dropdownNavs },
                                        ...
                                        <li key={idx}>
                                            ...
                                            }
                                            {
                                                item.isDrapdown && drapdownState.idx == idx && drapdownState.isActive ? (
                                                    <div className="mt-6 inset-x-0 top-20 w-full md:absolute md:border-y bg-white md:shadow-md md:mt-0">
                                                        <ul className='max-w-screen-xl mx-auto grid items-center gap-6 md:p-8 md:grid-cols-2 lg:grid-cols-3'>
                                                            {item?.navs.map((dropdownItem, idx) => (
                                                                <li key={idx}>
                                                                    <p className="text-indigo-600 text-sm font-bold font-mono">{dropdownItem.label}</p>
                                                                        ...
                                                                        {dropdownItem.navs.map((navItem, idx) => (
                                                                            <li key={idx} className="group">
                                                                                <a href={navItem.path} className='flex gap-3 items-center'>
                                                                                    ...
                                                                                    <div>
                                                                                        <span className="text-gray-800 duration-200 group-hover:text-indigo-600 text-sm font-medium md:text-base font-mono font-bold">{navItem.title}</span>
                                                                                        <p className='text-sm text-gray-600 group-hover:text-gray-800 mt-1 font-mono'>{navItem.desc}</p>
                                                                                    </div>
                                                                                </a>
                                                                            </li>
                                                                        ))}
